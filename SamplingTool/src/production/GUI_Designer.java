...
public class GUI_Designer extends JFrame {
	...
	public GUI_Designer() {
		...
		// inititalize FileDialog and set currentDirectory outside Button´s actionPerformed() so that
		// the dialog´s currentDirectory can be overwritten and rememered by the Button method
